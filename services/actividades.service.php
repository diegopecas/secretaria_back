...
class ActividadesService
{
    ...
    public static function crear()
    {
        ...
        ");
            ...
            try {
                // Insertar actividad principal - SOLO CAMPOS QUE EXISTEN EN LA BD
    ...
    public static function actualizar()
    {
        ...
        ");
            ...
            try {
                // Actualizar campos básicos - SOLO CAMPOS QUE EXISTEN EN LA BD
                $updates = [];
                $params = [':id' => $id];

                // Campos actualizables que SÍ existen en la BD
                $camposActualizables = [
                    'descripcion_actividad',
                    'fecha_actividad'
                ];
