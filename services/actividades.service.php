...
class ActividadesService
{
    ...
    {
        try {
            $contratista_id = Flight::request()->query->contratista_id;
            $contrato_id = Flight::request()->query->contrato_id;
    ...
    /**
     * Obtener actividades por contratista (agregar este método también)
     */
    public static function obtenerPorContratista()
    {
        try {
            $contratista_id = Flight::request()->query->contratista_id;
            ...
            // Reutilizar el método obtenerTodas con el filtro de contratista
            $_GET['contratista_id'] = $contratista_id;
            self::obtenerTodas();
        } catch (Exception $e) {
            error_log("Error al obtener actividades por contratista: " . $e->getMessage());
            Flight::json(['error' => 'Error al obtener actividades'], 500);
        }
    }
}
