...
class ContratosService
{
    ...
    public static function crear()
    {
        try {
            ...
            if (!$numero_contrato || !$contratista_id || !$entidad_id || 
    ...
    public static function actualizar()
    {
        try {
            ...
            try {
                ...
                // Otros campos
                $camposActualizables = [
                    'fecha_suscripcion', 'objeto_contrato', 'valor_total',
                    'dependencia', 'unidad_operativa', 'estado'
                ];
    ...
    public static function gestionarSupervisores()
    {
        try {
            ...
            try {
                ...
                // AUDITORÍA
                AuditService::registrar('contratos_supervisores', $contrato_id, 'UPDATE', 
    ...
    public static function gestionarObligaciones()
    {
        try {
            ...
            try {
                ...
                // AUDITORÍA
                AuditService::registrar('obligaciones_contractuales', $contrato_id, 'UPDATE', 
    ...
    public static function gestionarValoresMensuales()
    {
        try {
            ...
            try {
                ...
                // AUDITORÍA
                AuditService::registrar('valores_mensuales', $contrato_id, 'UPDATE', 
