...
```';
    ...
    /**
     * Transcribir audio a texto (No soportado por Gemini actualmente)
     */
    public function transcribirAudio(string $audioPath, array $configuracion = []): array
    {
        // Gemini actualmente no soporta transcripción directa de audio
        // Solo puede procesar audio si se convierte a formato de video con el audio
        throw new Exception(
            "Gemini no soporta transcripción directa de audio. " .
                "Use OpenAI Whisper o Web Speech API para transcripción."
        );
    }
}
